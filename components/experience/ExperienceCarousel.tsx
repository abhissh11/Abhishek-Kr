        ...
        <div className="w-full flex flex-col">
          {experiences.map((exp, idx) => (
            <AnimatedSection
              ...
              className="w-full"
            >
              <div className="flex flex-col p-6 md:p-8 bg-transparent border-2 border-transparent border-b-zinc-800/80 first:border-t-zinc-800/80 hover:rounded-2xl hover:bg-zinc-800/40 hover:border-zinc-700/60 transition-all duration-300 group">
                {/* Header Row */}
